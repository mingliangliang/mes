...
ALL : "$(OUTDIR)\DEWAV_ODM_ColorBoxTool.exe" "$(OUTDIR)\ColorBox.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_ColorBoxTool.exe"
...
LINK32=link.exe
LINK32_FLAGS=Adsapi32.lib Version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\DEWAV_ODM_ColorBoxTool.pdb" /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_ColorBoxTool.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ColorBox.obj" \
...
"$(OUTDIR)\DEWAV_ODM_ColorBoxTool.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(OUTDIR)\ColorBox.bsc"
	-@erase "$(OUTDIR)\DEWAV_ODM_ColorBoxTool.exe"
	-@erase "$(OUTDIR)\DEWAV_ODM_ColorBoxTool.ilk"
	-@erase "$(OUTDIR)\DEWAV_ODM_ColorBoxTool.pdb"
...
LINK32=link.exe
LINK32_FLAGS=Adsapi32.lib Version.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\DEWAV_ODM_ColorBoxTool.pdb" /debug /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_ColorBoxTool.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\ColorBox.obj" \
	"$(INTDIR)\ColorBoxDoc.obj" \
	"$(INTDIR)\ColorBoxView.obj" \
...
"$(INTDIR)\PrintSetting.obj"	"$(INTDIR)\PrintSetting.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\ColorBox.pch"
