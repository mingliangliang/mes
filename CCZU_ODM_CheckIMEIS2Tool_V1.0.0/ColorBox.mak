...
ALL : "$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.exe" "$(OUTDIR)\ColorBox.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.exe"
...
LINK32=link.exe
LINK32_FLAGS=Adsapi32.lib Version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.pdb" /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ColorBox.obj" \
...
"$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(OUTDIR)\ColorBox.bsc"
	-@erase "$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.exe"
	-@erase "$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.ilk"
	-@erase "$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.pdb"
...
LINK32=link.exe
LINK32_FLAGS=Adsapi32.lib Version.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.pdb" /debug /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_CheckIMEIS2Tool.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\ColorBox.obj" \
	"$(INTDIR)\ColorBoxDoc.obj" \
	"$(INTDIR)\ColorBoxView.obj" \
