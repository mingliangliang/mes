...
ALL : "$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.exe" "$(OUTDIR)\PACK.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.exe"
...
LINK32=link.exe
LINK32_FLAGS=Adsapi32.lib Version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.pdb" /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.exe" 
LINK32_OBJS= \
	"$(INTDIR)\BtnST.obj" \
	"$(INTDIR)\config.obj" \
	"$(INTDIR)\excel.obj" \
...
"$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.exe"
	-@erase "$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.ilk"
	-@erase "$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.pdb"
	-@erase "$(OUTDIR)\PACK.bsc"
...
LINK32=link.exe
LINK32_FLAGS=Adsapi32.lib Version.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.pdb" /debug /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_ProductionDataQueryTool.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\BtnST.obj" \
	"$(INTDIR)\config.obj" \
	"$(INTDIR)\excel.obj" \
...
"$(INTDIR)\excel.obj"	"$(INTDIR)\excel.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\PACK.pch"
...
"$(INTDIR)\Query.obj"	"$(INTDIR)\Query.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\PACK.pch"
