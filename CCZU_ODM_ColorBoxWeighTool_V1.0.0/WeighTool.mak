...
ALL : "$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.exe" "$(OUTDIR)\WeighTool.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.exe"
...
LINK32=link.exe
LINK32_FLAGS=Version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.pdb" /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.exe" 
LINK32_OBJS= \
	"$(INTDIR)\Buffer.obj" \
	"$(INTDIR)\Config.obj" \
	"$(INTDIR)\IniFile.obj" \
...
"$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(INTDIR)\WeighToolView.sbr"
	-@erase "$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.exe"
	-@erase "$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.ilk"
	-@erase "$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.pdb"
	-@erase "$(OUTDIR)\WeighTool.bsc"
...
LINK32=link.exe
LINK32_FLAGS=Version.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.pdb" /debug /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_ColorBoxWeighTool.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\Buffer.obj" \
	"$(INTDIR)\Config.obj" \
	"$(INTDIR)\IniFile.obj" \
