...
ALL : "$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.exe" "$(OUTDIR)\WeighTool.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.exe"
...
LINK32=link.exe
LINK32_FLAGS=Version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.pdb" /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.exe" 
LINK32_OBJS= \
	"$(INTDIR)\Buffer.obj" \
	"$(INTDIR)\Config.obj" \
	"$(INTDIR)\IniFile.obj" \
...
"$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(INTDIR)\WeighToolView.sbr"
	-@erase "$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.exe"
	-@erase "$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.ilk"
	-@erase "$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.pdb"
	-@erase "$(OUTDIR)\WeighTool.bsc"
...
LINK32=link.exe
LINK32_FLAGS=Version.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.pdb" /debug /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_CartonBoxWeighTool.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\Buffer.obj" \
	"$(INTDIR)\Config.obj" \
	"$(INTDIR)\IniFile.obj" \
