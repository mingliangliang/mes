...
ALL : "$(OUTDIR)\DEWAV_ODM_CheckOrderTool.exe" "$(OUTDIR)\WeighTool.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_CheckOrderTool.exe"
...
LINK32=link.exe
LINK32_FLAGS=Version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\DEWAV_ODM_CheckOrderTool.pdb" /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_CheckOrderTool.exe" 
LINK32_OBJS= \
	"$(INTDIR)\Buffer.obj" \
	"$(INTDIR)\Config.obj" \
	"$(INTDIR)\IniFile.obj" \
...
"$(OUTDIR)\DEWAV_ODM_CheckOrderTool.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "$(OUTDIR)\DEWAV_ODM_CheckOrder.exe" "$(OUTDIR)\WeighTool.bsc"
...
CLEAN :
	...
	-@erase "$(INTDIR)\WeighToolView.obj"
	-@erase "$(INTDIR)\WeighToolView.sbr"
	-@erase "$(OUTDIR)\DEWAV_ODM_CheckOrder.exe"
	-@erase "$(OUTDIR)\DEWAV_ODM_CheckOrder.ilk"
	-@erase "$(OUTDIR)\DEWAV_ODM_CheckOrder.pdb"
	-@erase "$(OUTDIR)\WeighTool.bsc"
...
LINK32=link.exe
LINK32_FLAGS=Version.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\DEWAV_ODM_CheckOrder.pdb" /debug /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_CheckOrder.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\Buffer.obj" \
	"$(INTDIR)\Config.obj" \
	"$(INTDIR)\IniFile.obj" \
...
"$(OUTDIR)\DEWAV_ODM_CheckOrder.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
