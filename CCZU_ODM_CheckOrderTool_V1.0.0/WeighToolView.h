...
public:
	...
	int m_iPalletNameSNLength;
	CString m_csCurrent_PalletNameStatic;
	CString m_csCurrent_PalletName;

	CString m_csCartonNameStatic;//lucky
	int m_iCartonNameSNLength;	
	CString m_csCurrent_CartonNameStatic;
	CString m_csCurrent_CartonName;
