...
ALL : "$(OUTDIR)\DEWAV_ODM_CartonBoxTool.exe" "$(OUTDIR)\PACK.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_CartonBoxTool.exe"
...
LINK32=link.exe
LINK32_FLAGS=Adsapi32.lib Version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\DEWAV_ODM_CartonBoxTool.pdb" /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_CartonBoxTool.exe" 
LINK32_OBJS= \
	"$(INTDIR)\BtnST.obj" \
...
"$(OUTDIR)\DEWAV_ODM_CartonBoxTool.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(OUTDIR)\DEWAV_ODM_CartonBoxTool.exe"
	-@erase "$(OUTDIR)\DEWAV_ODM_CartonBoxTool.pdb"
	-@erase "$(OUTDIR)\PACK.bsc"
...
LINK32=link.exe
LINK32_FLAGS=Adsapi32.lib Version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\DEWAV_ODM_CartonBoxTool.pdb" /debug /machine:I386 /out:"$(OUTDIR)\DEWAV_ODM_CartonBoxTool.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\BtnST.obj" \
	"$(INTDIR)\CartonBoxPrint.obj" \
	"$(INTDIR)\config.obj" \
