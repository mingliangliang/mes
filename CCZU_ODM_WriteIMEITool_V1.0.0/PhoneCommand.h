...
{   
    ...
    unsigned short  nData[6000];    //buffer
...
SP_EXPORT int       SP_API SP_GetExVersion  (SP_HANDLE hDiagPhone, void *lpBuff, unsigned long ulBuffLen);//lucky 20160106
...
SP_EXPORT int SP_API SP_apExitProgramKey(SP_HANDLE hDiagPhone);
//
...
//lucky 20160113
SP_EXPORT int SP_API SP_WriteTraceInfo(SP_HANDLE hDiagPhone, void *lpBuff, unsigned long ulBuffLen);
SP_EXPORT int SP_API SP_ReadTraceInfo(SP_HANDLE hDiagPhone, void *lpBuff, unsigned long ulBuffLen);
//
