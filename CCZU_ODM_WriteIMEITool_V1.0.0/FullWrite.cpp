// FullWrite.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CFullWriteApp, CWinApp)
	//{{AFX_MSG_MAP(CFullWriteApp)
...
/////////////////////////////////////////////////////////////////////////////
// CFullWriteApp construction

CFullWriteApp::CFullWriteApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CFullWriteApp object

CFullWriteApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CFullWriteApp initialization

BOOL CFullWriteApp::InitInstance()
{
	AfxOleInit();
	AfxInitRichEdit();
	...
	{
		AfxMessageBox("Connect SQL Fail!");
		return FALSE;
	}
	...
	if (LoginDlg.DoModal() == IDOK)
	{
		...
		pDocTemplate = new CSingleDocTemplate(
			IDR_MAINFRAME,
			RUNTIME_CLASS(CFullWriteDoc),
			RUNTIME_CLASS(CMainFrame),       // main SDI frame window
			RUNTIME_CLASS(CFullWriteView));
		...
		m_pMainWnd->SetWindowText("CCZU ODM MES System——Write IMEI Tool");
...
void CFullWriteApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

BOOL CFullWriteApp::InitADO()
{
	CoInitialize(NULL);	
	HRESULT hrpC,hrpR;
...
bool CFullWriteApp::ConnectMDBDatabase()
{	
	CString temp;
	_variant_t var;
	CString sql;
...
BOOL CFullWriteApp::CheckToolVersion()
{
	CString     csVer;
	CString     strVersion ;
	CString     sql;
	...
	try
	{
		...
		if(!m_pRst->adoEOF)
		{
			var = m_pRst->GetCollect("WriteIMEITool");
	...
	{
		AfxMessageBox("SoftWare Version Error"+csVer+"!");
		return FALSE;
	}
